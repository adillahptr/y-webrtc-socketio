...
const setupWS = (wsclient) => {
  if (wsclient.shouldConnect && wsclient.ws === null) {
    ...
    wsclient.ws = socket
    wsclient.wsconnecting = true
    wsclient.wsconnected = false

  }
}

class SignalingConn extends observable.Observable /*ws.WebsocketClient*/ {
  constructor (url, { binaryType } = {}) {
    ...
    this.ws.on('disconnect', () => log(`disconnect (${url})`))
  }
